...
const zhCN: Record<string, string> = {
  ...
  'Tap continue, then enter this one-time code on OpenAI. This screen will finish automatically.': '点击继续，然后在 OpenAI 页面输入此一次性代码。完成后此页面会自动继续。',
  'Copy device code': '复制设备代码',
  'Copied': '已复制',
  'Tap to copy': '点击复制',
  'Waiting for sign-in…': '正在等待登录…',
  'Copy code & continue': '复制代码并继续',
  'Codex login stopped. Start again to continue.': 'Codex 登录已停止。请重新开始。',
  'Sign in with ChatGPT to use Codex models.': '使用 ChatGPT 登录以使用 Codex 模型。',
